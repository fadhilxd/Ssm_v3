          ...
          <div class="form-body">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="profile-avatar">
                  <img width="200" height="200" class="img-avatar-profile" src="<?=get_field(USERS, ["id" => session('uid')], 'profile_img')?>" alt="">

                  <div class="form-group">
                    <label for="projectinput5"><?=lang('Profile_Image')?></label>
                    <input class="form-control square" name="profile_img" type="text" value="<?=(!empty($user->profile_img))? $user->profile_img: ''?>">
                    <small class="text-primary"><?=lang("paste_here_the_image_link_you_want_to_add_to_your_platform_profile")?></small>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                  ...
                  <input class="form-control square" type="password">
