          ...
          <tbody>
            ...
            <tr class="tr_<?=$row->ids?>">
              ...
              <td class="text-center" style="width: 15%;">
                <div class="btn-group">
                  <a href="<?=cn("$module/update/".$row->ids)?>" class="btn-mini btn-icon btn-outline-info ajaxModal" data-toggle="tooltip" data-placement="bottom" title="<?=lang("edit_api")?>"><i class="far fa-edit"></i></a>
                  <a href="<?=cn("$module/ajax_update_api_provider/".$row->ids)?>" data-redirect="<?=cn($module)?>"  class="btn-mini btn-icon btn-outline-info ajaxUpdateApiProvider" data-toggle="tooltip" data-placement="bottom" title="<?=lang("update_balance")?>"><i class="far fa-dollar-sign"></i></a>

                  <a href="<?=cn($module."/sync_services/".$row->ids)?>" class="btn-mini btn-icon btn-outline-info ajaxModal" data-toggle="tooltip" data-placement="bottom" title="<?=lang("sync_services")?>"><i class="fad fa-sync-alt"></i></a>

                  <a href="<?=cn('api_provider/services')?>" class="btn-mini btn-icon btn-outline-info" data-toggle="tooltip" data-placement="bottom" title="<?=lang("services_list_via_api")?>"><i class="far fa-list"></i></a>

                  <a href="<?=cn("$module/ajax_delete_item/".$row->ids)?>" class="btn-mini btn-icon btn-outline-info ajaxDeleteItem" data-toggle="tooltip" data-placement="bottom" title="<?=lang("Delete")?>"><i class="far fa-trash-2"></i></a>
