  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-options">
        <a href="<?=cn($module."/bulk_services/$api_ids")?>" class="ajaxModal btn btn-pill btn-info btn-sm"><span class="mr-1"><i class="fas fa-plus-square"></i></span><?=lang("bulk_add_all_services")?>
        </a>
      </div>
      <?php } ?>
    </div>
            ...
            <td class="text-center">
              <div class="item-action dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <a href="<?=cn("$module/add_service/")?>" data-serviceid="<?=$row->service?>" data-category="<?=$row->category?>" data-name="<?=$row->name?>" data-min="<?=$row->min?>" data-max="<?=$row->max?>" data-price="<?=$row->rate?>" data-type="<?=$row->type?>" data-dripfeed="<?=$row->dripfeed?>" data-api_provider_id="<?=$api_id?>" class="ajaxAddService dropdown-item"><i class="dropdown-icon fas fa-plus-square"></i> <?=lang("add_update_service")?></a>
                </div>
              </div>
            </td>
          </tr>
