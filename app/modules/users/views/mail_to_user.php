      ...
      <div class="modal-content">
        <form class="form actionForm" action="<?=cn($module."/ajax_send_email")?>" data-redirect="<?=cn($module)?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="feather icon-mail"></i> <?=lang('send_mail')?></h4>
...
<script src="<?=BASE?>assets/plugins/ckeditorClassic/ckeditor.js" type="text/javascript"></script>
<script>
