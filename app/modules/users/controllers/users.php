...
class users extends MX_Controller {
	...
	public function index(){
		...
		$config = array(
			...
			'prev_link'          => '<i class="feather icon-chevron-left"></i>',
			'first_link'         => '<i class="feather icon-chevrons-left"></i>',
			'next_link'          => '<i class="feather icon-chevron-right"></i>',
			'last_link'          => '<i class="feather icon-chevrons-right"></i>',
		);
