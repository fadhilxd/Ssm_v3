  ...
  <div class="row justify-content-between">
    <div class="col-md-6">
      <h1 class="page-title d-flex">
        ...
        <span class="d-none d-sm-block"><i class="feather icon-mail text-primary" aria-hidden="true"></i></span> 
        &nbsp;<?=lang("Tickets")?>
      </h1>
    </div>
    <div class="col-md-2">
  ...
  <div class="col-md-5 d-sm-block">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">
          <h4 class="modal-title"><i class="feather icon-edit"></i> <?=lang("add_new_ticket")?></h4>
        </h3>
            ...
            <div class="row justify-content-md-center">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <textarea rows="3" id="editor" class="form-control square" name="description" placeholder="<?=lang("Type_your_message")?>"></textarea>
                </div>
              </div>
  ...
  <div class="col-md-7">
    <div class="row" id="result_ajaxSearch">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><i class="feather icon-list"></i> <?=lang("Lists")?>
            </h3>
            <div class="card-options">
              <a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="feather icon-chevron-up"></i></a>
              <a href="#" class="card-options-remove" data-toggle="card-remove"><i class="feather icon-x"></i></a>
          ...
          <div class="card-body o-auto" style="height: calc(100vh - 180px);background-image: url(<?=BASE?>assets/svgs/chat-bg.svg); background-color: #DFDBE5!important;">
              ...
              <div class="item tr_<?=$row->ids?>">
                ...
                <div class="action item-action dropdown m-t-10">
                  ...
                  <a href="javascript:void(0)"class="m-r-5">
                    <span style="position: absolute;top: -20px; right: 20px;" class="btn round <?=$button_type?> btn-sm"><small><?=ticket_status_title($row->status)?></small>
                    </span>
                  </a>
                  <?php 
                  if(get_role("admin") || get_role('supporter')) {?>
                  <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="far fa-chevron-up"></i></a>
                  <div class="dropdown-menu dropdown-menu-right">
                    <a href="javascript:void(0)" data-url="<?=cn($module."/ajax_change_status/".$row->ids)?>" data-status="new" class="ajaxChangeStatus dropdown-item"> <i class="dropdown-icon far fa-envelope"></i> <?=lang("mark_as_new")?></a>
                    ...
                    <a href="javascript:void(0)" data-url="<?=cn($module."/ajax_change_status/".$row->ids)?>" data-status="closed" class="ajaxChangeStatus dropdown-item"> <i class="dropdown-icon far fa-lock-alt"></i> <?=lang("mark_as_closed")?></a>
                    <?php 
                      if (get_role('admin')) {
                    ?>
                    <a href="<?=cn("$module/ajax_delete_item/".$row->ids)?>" class="ajaxDeleteItem dropdown-item"> <i class="dropdown-icon far fa-trash-alt"></i> <?=lang("Delete")?></a>
                    <?php }?>
                  </div>
                  <?php }?>
                </div>
