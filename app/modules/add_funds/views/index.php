...
/*
*
* Made by Shibin Pops - https://cheapestpanel.in/ 
*
*/
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <?php
                if (get_option("is_active_razor_pay")) {
              ?>
              <div id="razor_pay" class="tab-pane fade in active show">
                ...
                <input type="hidden" value="<?php echo $this->security->get_csrf_hash();?>"  name="<?php echo $this->security->get_csrf_token_name(); ?>">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      ?>
                      <div class="for-group text-center">
                        <img src="<?=BASE?>/assets/images/razorpay.jpg" alt="Razorpay icon">
