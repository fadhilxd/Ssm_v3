    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="feather icon-settings"></i> <?=lang("default_setting")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?=cn($module."?t=".$tab)?>">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              <h5 class="text-info"><i class="far fa-link"></i> <?=lang('Default_Homepage')?></h5>
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h5 class="text-info"><i class="far fa-line-columns"></i> <?=lang("Pagination")?></h5>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <h5 class="text-info"><i class="far fa-globe-americas"></i> <?=lang("default_timezone")?></h5>
                  <div class="form-group">
              ...
              <h5 class="text-info"><i class="fal fa-ticket-alt"></i> <?=lang("default_tickets_log")?></h5>
              <div class="row">
                <div class="col-md-6">
              ...
              <h5 class="text-info"><i class="feather icon-settings"></i> <?=lang("default_service")?></h5>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
              ...
              <h5 class="text-info"><i class="feather icon-droplet"></i> <?=lang("dripfeed_option")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
              ...
              <h5 class="text-info"><i class="feather icon-bell"></i> <?=lang("notification_popup_at_home_page")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="far fa-home"></i> <?=lang("disable_home_page_langding_page")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fad fa-flag-checkered"></i> <?=lang("explication_of_the_service_symbol")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="far fa-laptop"></i> <?=lang("displays_the_service_lists_without_login_or_register")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="far fa-rss-square"></i> <?=lang("displays_news__announcement_feature")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="far fa-laptop-code"></i> <?=lang("displays_api_tab_in_header")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fab fa-skype"></i> <?=lang("displays_required_skypeid_field_in_signup_page")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
              ...
              <h5 class="m-t-10"><i class="fab fa-google"></i> <?=lang("displays_google_recapcha")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
