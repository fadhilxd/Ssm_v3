    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="far fa-edit"></i> <?=lang("email_template")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?=cn($module."?t=".$tab)?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <h5 class="text-info"><i class="far fa-envelope"></i> <?=lang("email_verification_for_new_customer_accounts")?></h5>
              ...
              <div class="form-group">
                ...
                <textarea rows="3" name="verification_email_content" id="verify" class="form-control"><?=get_option('verification_email_content', getEmailTemplate("verify")->content)?>
                </textarea>
              </div>

              <h5 class="text-info"><i class="far fa-envelope"></i> <?=lang("new_user_welcome_email")?></h5>
              <div class="form-group">
                <label class="form-label"><?=lang("Subject")?></label>
              ...
              <h5 class="text-info"><i class="far fa-envelope"></i> <?=lang("new_user_notification_email")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("Subject")?></label>
              ...
              <h5 class="text-info"><i class="far fa-envelope"></i> <?=lang("password_recovery")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("Subject")?></label>
              ...
              <h5 class="text-info"><i class="far fa-envelope"></i> <?=lang("payment_notification_email")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("Subject")?></label>
