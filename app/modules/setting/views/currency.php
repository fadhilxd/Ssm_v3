    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-usd-circle"></i> <?=lang("currency_setting")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>"  method="POST" data-redirect="<?=cn($module."?t=".$tab)?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <h5 class="text-info"><i class="fas fa-usd-circle"></i> <?=lang("currency_setting")?></h5>
              ...
              <h5 class="text-info"><i class="far fa-chart-line"></i> <?=lang("price_percentage_increase")?></h5>
              <div class="row">
              ...
              <h5 class="text-info"><i class="fal fa-balance-scale"></i> <?=lang("auto_currency_converter")?></h5>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input style="padding-right: 120px" type="text" class="form-control text-right" name="new_currecry_rate" value="<?=get_option('new_currecry_rate', 1)?>">
