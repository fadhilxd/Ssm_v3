                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td class="table-plus" style="width: 40%">
                                      <?=(strlen($row->slug) >= 20)? truncate_string($row->slug, 20) : $row->slug?></td>
                                    <td style="width: 60%;">
                                      <?php if(strlen($row->value) >= 64){?>
                                      <div class="form-group">
                                        <textarea class="form-control" name='lang[<?=$row->slug?>]' style="max-height: 55px;"><?=(isset($lang_db[$row->slug])) ? $lang_db[$row->slug] : $row->value?>
                                        </textarea>
                                      </div>
                                      <?php }else{?>
                                        <div class="form-group">
                                          <input class="form-control" type="text" name='lang[<?=$row->slug?>]' value="<?=(isset($lang_db[$row->slug])) ? $lang_db[$row->slug] : $row->value?>">
                                        </div>
                                      <?php }?>
                                    </td>
                                  </tr>
