...
<head><meta charset="windows-1252">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <meta name="description" content="<?=get_option('website_desc', "CheapestPanel - #1 SMM Reseller Panel - Best SMM Panel for Resellers. Also well known for TOP SMM Panel and Cheap SMM Panel for all kind of Social Media Marketing Services. SMM Panel for Facebook, Instagram, YouTube and more services!")?>">
    <meta name="keywords" content="<?=get_option('website_keywords', "smm panel, CheapestPanel, smm reseller panel, smm provider panel, reseller panel, instagram panel, resellerpanel, social media reseller panel, smmpanel, panelsmm, smm, panel, socialmedia, instagram reseller panel")?>">
    <title><?=get_option('website_title', "CheapestPanel - SMM Panel Reseller Tool")?></title>
  ...
  <![endif]-->
      ...
      <link rel="stylesheet" type="text/css" href="/pops/css/css.css">
      <link rel="stylesheet" type="text/css" href="/pops/css/css1.css">
...
<div id="mainPage" />
<img class="layer layer-8" src="/pops/images/fog.svg">
    <div class="hero">
        <div class="wrapper"><img class="layer layer-1" src="/pops/images/Ellipse.svg">
            <div class="hero-inner">
                ...
                <div class="hero-image">
                    <div class="radial-gradient-hero"></div><img class="layer rocket layer-2" src="/pops/images/rocketman.svg"> <img class="layer icons layer-3" src="/pops/images/facebook-icon.svg"> <img class="layer icons layer-4" src="/pops/images/fb-like-icon.svg"> <img class="layer icons layer-5" src="/pops/images/instagram-icon.svg"> <img class="layer icons layer-6" src="/pops/images/like-icon.svg"> <img class="layer icons layer-7" src="/pops/images/play-iconm.svg"></div>
            </div>
        </div>
    </div>
    <div class="wrapper">
        <div class="stats">
            <div class="stats-img"><img class="layer-9" src="/pops/images/hand.svg"> <img class="layer-10" src="/pops/images/arrow 2.svg"> <img class="layer-11" src="/pops/images/arrow 2.svg"> <img class="layer-12" src="/pops/images/instagram-icon.svg"> <img class="layer-13" src="/pops/images/instagram-icon.svg"> <img class="layer-14" src="/pops/images/fb-like-icon.svg"></div>
            <div class="stats-info">
                <div class="members slide-up stat-info-inner"><img class="stats-info_icon" src="/pops/images/member-icon.svg">
                    <p>Active Members</p>
                    <h1>26K+</h1></div>
                <div class="chart slide-up stat-info-inner"><img class="stats-info_icon" src="/pops/images/chart.svg">
                    <p>Total Orders on CheapestPanel</p>
                    <h1>250K+</h1></div>
                <div class="dollar slide-up stat-info-inner"><img class="stats-info_icon" src="/pops/images/dollar.svg">
        ...
        <div class="wrapper">
            <div class="arrows-wrapper">
                <div class="custom-arrows">
                    <li class="prev-arrow"><img src="/pops/images/prev.svg"></li>
                    <li class="next-arrow"><img src="/pops/images/next.svg"></li>
                </div>
            </div>
            <div class="slider">
                <div class="service"><img class="service-anim" src="/pops/images/like-orange.svg">
                ...
                <div class="service"><img class="service-anim" src="/pops/images/followers.svg">
                    <h1 class="service-anim">Followers</h1>
                    <p class="service-anim">Gain followers Fast and Easy. Fast Delivery High Quality Users</p>
                </div>
                <div class="service"><img class="service-anim" src="/pops/images/views.svg">
                    <h1 class="service-anim">Views</h1>
                    <p class="service-anim">Get views for your posts to increase and attract new audience<a href="https://cheapestpanel.in">.</a></p>
                </div>
                <div class="service"><img class="service-anim" src="/pops/images/chart-icon.svg">
                ...
                <div class="service"><img class="service-anim" src="/pops/images/star.svg">
    ...
    <div class="about">
        ...
        <div class="city-bg"><img src="/pops/images/city.svg"></div>
        <div class="wrapper">
            <div class="about-inner">
                ...
                <div class="about-slide">
                    <div class="about-slide-info">
                        ...
                        <p> We Provide 100% Real & Human Viewers, NO Bots / Spam methods used<a href="https://cheapestpanel.in">.</a> Our YouTube Views RAV™ and Live Stream Views help in ranking and can be running with Ads ON.</p>
                    </div>
                    <div class="about-slide-image"><img src="/pops/images/333.png"></div>
                </div>
              <div class="about-slide">
                    <div class="about-slide-info">
        ...
        will make sure to deliver the service in the natural way, Check out our options.</p>
                    ...
                    <div class="about-slide-image"><img src="/pops/images/222.png"></div>
                </div>
              <div class="about-slide">
                    <div class="about-slide-info">
                        <h1>Resellers One Stop Shop for SMM Services</h1>
                        <p>Full API Support, From Payment to Delivery 100% Hands Free!<br>
        Get <a href="https://cheapestpanel.in" tabindex="0"> SMM Panel Script</a> and start your own SMM Reseller business</p></p>
                    </div>
                    <div class="about-slide-image"><img src="/pops/images/111.png"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="wrapper">
            ...
            <p><?=get_option('copy_right_content',"Copyright &copy; 2021 INDIAN OF SMM ");?></p>    
...
<!-- Main variables *content* -->
  ...
  <script type="text/javascript" src="/pops/js/js.js">
      </script>
  <script type="text/javascript" src="/pops/js/js1.js">
      </script>
  <script type="text/javascript" src="/pops/js/js2.js">
      </script>
  <script type="text/javascript" src="/pops/js/js3.js">
      </script>
  <script type="text/javascript" src="/pops/js/js4.js">
      </script>
  <script type="text/javascript" src="/pops/js/js5.js">
      </script>
